...
SELECT CD_COMPANY, CD_PAYGP, FG_SUPP
	 ...
	 , (SELECT NM_DETAIL FROM dwehrdev.dbo.B_DETAIL_CODE where CD_MASTER = 'HU187' AND CD_DETAIL=CD_PAYGP) OLD_PAYGP
	 , (SELECT NM_DETAIL FROM dwehrdev.dbo.B_DETAIL_CODE where CD_MASTER = 'HU109' AND CD_DETAIL=FG_SUPP) NM_SUPP
  FROM (

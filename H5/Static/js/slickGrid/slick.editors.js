...
(function($) {
    ...
    var SlickEditor = {
        ...
        BoolCellFormatter : function(row, cell, value, columnDef, dataContext) {
            return value ? "<img src='/common/js/slickGrid/images/tick.png'>" : "";
        },
        ...
        TaskNameFormatter : function(row, cell, value, columnDef, dataContext) {
            ...
            return spacer + " <img src='/common/js/slickGrid/images/expand.gif'>&nbsp;" + value;
        },
        ...
        ResourcesFormatter : function(row, cell, value, columnDef, dataContext) {
            ...
            if (columnDef.width < 50)
                return (resources.length > 1 ? "<center><img src='/common/js/slickGrid/images/user_identity_plus.gif' " : "<center><img src='/common/js/slickGrid/images/user_identity.gif' ") +
        ...
        StarFormatter : function(row, cell, value, columnDef, dataContext) {
            return (value) ? "<img src='/common/js/slickGrid/images/bullet_star.png' align='absmiddle'>" : "";
        },
        ...
        DateCellEditor : function(args) {
            ...
            this.init = function() {
                ...
                $input.datepicker({
                    ...
                    buttonImage: "/common/js/slickGrid/images/calendar.gif",
        ...
        StarCellEditor : function(args) {
            ...
            this.init = function() {
                $input = $("<IMG src='/common/js/slickGrid/images/bullet_star.png' align=absmiddle tabIndex=0 title='Click or press Space to toggle' />")

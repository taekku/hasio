USE [dwehrdev_H5]
GO
/****** Object:  StoredProcedure [dbo].[P_REP_ESTIMATION]    Script Date: 2021-01-28 오후 5:22:04 ******/
SET ANSI_NULLS ON
GO
...
PRINT('시작 ===> 1 ' + FORMAT(SYSDATETIME(), 'HH:mm:ss.fffff'))
PRINT('@v_ins_type_cd ===> ' + @v_ins_type_cd)
            ...
            BEGIN 
				...
				ELSE
					...
					END 
            END 
PRINT('시작 ===> 2 ' + FORMAT(SYSDATETIME(), 'HH:mm:ss.fffff'))
PRINT('@v_ins_type_cd ===> ' + @v_ins_type_cd)	
			---- ***************************************   
			---- 2. 평균임금 산정   
			---- ***************************************  
...
PRINT('시작 ===> 3 ' + FORMAT(SYSDATETIME(), 'HH:mm:ss.fffff'))

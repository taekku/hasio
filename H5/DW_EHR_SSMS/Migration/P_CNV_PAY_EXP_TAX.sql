...
GO
-- =============================================
-- Description:	Conversion 개인별원천징수세율등록
-- 
-- =============================================
		...
		BEGIN
			...
			BEGIN TRY
				...
				SELECT NEXT VALUE FOR S_PAY_SEQUENCE as PAY_EXP_TAX_ID,
						@t_company_cd COMPANY_CD, -- 인사영역
						@emp_id	EMP_ID, --	사원ID
						A.RATE_TAX TAX_RATE, -- 징수율
						A.YM_PAY_FR STA_YM, --	시작년월
						A.YM_PAY_TO END_YM, --	종료년월
						A.REMARK NOTE, --	비고
						  0 AS MOD_USER_ID

...
GO
-- =============================================
-- Description:	Conversion 고정공제관리
-- 
-- =============================================
CREATE OR ALTER PROCEDURE P_CNV_PAY_FIXED_DEDUCTION
...
BEGIN
	...
	set @v_t_table = 'PAY_FIXED_DEDUCTION' -- To-Be Table
	-- =============================================
	-- 전환프로그램설명
	-- =============================================
	...
	WHILE 1 = 1
		BEGIN
			...
			BEGIN TRY
				...
				-- =======================================================
				INSERT INTO dwehrdev_H5.dbo.PAY_FIXED_DEDUCTION(
							PAY_FIXED_DEDUCTION_ID, --	고정공제등록ID
							COMPANY_CD, --	회사코드
							EMP_ID, --	사원ID
							PAY_ITEM_CD, --	급여항목
							AMT, --	공제금액
				...
				SELECT NEXT VALUE FOR S_PAY_SEQUENCE as PAY_FIXED_PAY_ID
						, @t_company_cd AS COMPANY_CD,
							@emp_id as EMP_ID,
							@pay_item_cd	EXTRA_PAY_ITEM, --	급여항목
							AMT_ITEM	AMT, --	금액

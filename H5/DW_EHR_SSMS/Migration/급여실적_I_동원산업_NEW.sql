...
set @av_company_cd = 'I'
-- I(동원산업):200801 ~ 201412 선원
--insert into @bundle(FR_MONTH, TO_MONTH) values ('200801','200812')
--insert into @bundle(FR_MONTH, TO_MONTH) values ('200901','200912')
--insert into @bundle(FR_MONTH, TO_MONTH) values ('201001','201012') -- 사번없음 20100023
--insert into @bundle(FR_MONTH, TO_MONTH) values ('201101','201112')
--insert into @bundle(FR_MONTH, TO_MONTH) values ('201201','201212')

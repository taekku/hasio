...
-- 
-- =============================================
CREATE OR ALTER PROCEDURE [dbo].[P_CNV_PAY_PAYROLL_FnB_PAY]
...
BEGIN
	...
	set @v_s_table = 'CNV_PAY_DTL_SAP_01'   -- As-Is Table
	...
	WHILE 1=1
		BEGIN
			...
			BEGIN TRY
				...
				EXEC @pay_ymd_id = P_CNV_PAY_PAY_YMD_SAP_PAY @an_log_h_id=@n_log_h_id, @av_company_cd=@av_company_cd,

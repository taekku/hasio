 ...
 *================================================== 
 */
//true 값에 따라서 되고 안되고 함 !!!! 문제 발생요인은 아 파일에서 시작 됨 
(function() {
...
//            "sources.js",
        ...
        try {
            ...
            if (bundle) {
                ...
                includeCssFiles("/common/themes/timeline/" , cssFiles);
            ...
            for (var l = 0; l < supportedLocales.length; l++) {
                ...
                if (loadLocale[locale]) {
                    includeJavascriptFiles(Timeline.urlPrefix + locale + "/", localizedJavascriptFiles);
                    includeCssFiles(Timeline.urlPrefix + locale + "/", localizedCssFiles);
                }
            }
...
//    	alert("stop2!!!");
        ...
        var url = useLocalResources ?
            "/common/js/timeline/simile-ajax-api.js?bundle=false" :
            "http://api.simile-widgets.org/ajax/2.2.1/simile-ajax-api.js";
        if (typeof Timeline_ajax_url == "string") {
           url = Timeline_ajax_url;
        }
        url = "/common/js/timeline/simile-ajax-api.js";
        ...
        if (document.body == null) { //널이 아니여서 바디에 쓰지 못하여 import 가 안되었었음 
            try {
//            	alert("check document.doby == null area !");

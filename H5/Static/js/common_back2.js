...
(function($) {
	...
	*/
	//document.write('<script type="text/javascript" src="/common/jquery/jquery-1.6.2.min.js"></script>');
	document.write('<script type="text/javascript" src="/common/js/json2.js"></script>');
	document.write('<script type="text/javascript" src="/common/jquery-plugin/jquery.maskedinput-1.3.js"></script>');
	document.write('<script type="text/javascript" src="/common/jquery/jquery-ui.js"></script>');
	document.write('<script type="text/javascript" src="/common/jquery-plugin/jquery.layout-latest.js"></script>');

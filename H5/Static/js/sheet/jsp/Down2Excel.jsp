...
<%
	...
	// 사용하지 않으시려면 주석처리 하세요.
	// 
	ibExcel.setFontName("맑은고딕");
	ibExcel.setFontSize((short)10);
	//====================================================================================================
	// [ 사용자 환경 설정 #6 ]
	//====================================================================================================
	...
	if( ip.equals("172.20.31.51") || ip.equals("172.20.31.52") ) {
		//운영
		tempRoot = "/SVN/src/IBSheet7.TestPage";
	} else {
		//나머지
		tempRoot = "D:/SVN/src/IBSheet7.TestPage";
	}
	...
	try {
		...
		if (bToken) {
           ...
           // 파라메터 정보를 얻음
            ...
            String excelMakePath = webRootPath + "/" + fileName;
            System.out.println("excelMakePath : " + excelMakePath);
            boolean iret = false; 
			int retVal = 0;
			...
			String strOrgFilePath = excelMakePath;
			String strFileName = "test.txt";
			String strEncFilePath = excelMakePath;
            ...
            //-------------------------------------------------------------------------------------------------------
            File file = new File( objWorkPackager.getContainerFilePathName() ); 

DECLARE 
	...
	set @cd_master = 'HU010' -- 급여그룹
	set @cd_kind = 'PBT_POS_GRD_CD'
	set @cd_company = 'X'
...
SELECT NEXT VALUE FOR dbo.S_FRM_SEQUENCE
     , 'KO', CD_COMPANY, @cd_kind, CD_DETAIL, NM_DETAIL, NM_DETAIL, '19000101', '29991231', CD_DONGBU, YN_USE, SEQ_DISPLAY, TXT_DESC, 0, DT_UPDATE

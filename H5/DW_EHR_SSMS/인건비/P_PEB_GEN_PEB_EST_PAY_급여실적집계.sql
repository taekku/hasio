  ...
  -- 기존자료 삭제
	...
	BEGIN TRY
		...
		SELECT YMD.PAY_YM BASE_YM
			 , PAY.ORG_ID
			 , dbo.F_PEB_GET_VIEW_CD('인건비', PAY.POS_GRD_CD, PAY.POS_CD, PAY.DUTY_CD, PAY.JOB_POSITION_CD) AS VIEW_CD
		 ...
		 GROUP BY YMD.PAY_YM, PAY.ORG_ID, dbo.F_PEB_GET_VIEW_CD('인건비', PAY.POS_GRD_CD, PAY.POS_CD, PAY.DUTY_CD, PAY.JOB_POSITION_CD)
----------------
-- 일용직급여 시작
----------------
		INSERT INTO @TEMP_EST_PAY(

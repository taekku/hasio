...
--		   , @v_std_kind	NVARCHAR(2000) = 'PAY_ABS_DTM_MNG,PAY_ACCOUNT_BANK_SET,PAY_ADJ1_MNG,PAY_ADJ2_MNG,PAY_ANY_DEDU,PAY_BAS_DTM_CD,PAY_BAS_DTM_DED,PAY_BAS_TIME_ITEM,PAY_BASE_APPOINT,PAY_BASE_CONTROL,PAY_BASE_DUTY,PAY_BASE_FAM,PAY_BASE_FAM_F,PAY_BASE_FAM_X,PAY_BASE_JOB,PAY_BASE_LICENSE,PAY_BASE_ONEMIND,PAY_BASE_POS,PAY_BASE_TRAN,PAY_BASE_TRAN_DUTY,PAY_BNS_BASE_ITEM,PAY_BNS_ITEM_PL,PAY_BNS_ITEM_PL2,PAY_BONUS_RATE,PAY_CAM_DAILY_MAP,PAY_CAM_MST_MAP,PAY_CONT_SER,PAY_DEDUCT_SLIP,PAY_DEPOSITS_SLIP,PAY_DTM_DED_ITEM,PAY_DTM_MST_MAP,PAY_ETC_PAY,PAY_ETC_SLIP,PAY_ETC01_SLIP,PAY_FIXED_DEDUCTION,PAY_GRP_BNS_ITEM,PAY_GRP_CAM_MAP,PAY_GRP_DTM_MAP,PAY_HANDCAP_AMT,PAY_HOL_BNS,PAY_ITEM_CD_BASE,PAY_JOP_GROUP,PAY_KIMCH_PAY_AMT,PAY_MEAL_TAX_BIZ,PAY_MEAL_WK_DAY,PAY_MIN_PAY_ITEM,PAY_MINPAY_ITEM,PAY_MST_CHANGE_ADD,PAY_ORDWAGE_ITEM,PAY_ORG_TIME_ITEM,PAY_OT_BASE,PAY_PAY_SLIP,PAY_PAY_TYPE_CD,PAY_PBT_BILL,PAY_PBT_CUST,PAY_PBT_HRTYPE,PAY_PROD_INNO_ITEM,PAY_PROD_NOTAX,PAY_PRODUCT_WAGE,PAY_SELFDEV_WAGE,PAY_SHIP_NOTAX,PAY_SINGULAR_EXE,PAY_SLIP_SAP,PAY_SLIP_SAP_COM,PAY_SLIP_SAP_COST,PAY_STR_DED_ITEM,PAY_TAX_ALLW,PAY_TERM_YMD,PAY_TRA_BASE_AMT,PAY_TYPE_CLOSE_SET,PAY_TYPE_SALARY_STD,PAY_UNION_DED,PAY_WK_TYPE_CNG,PAY_WORK_PAY_ITEM,PAY_YEAR_MIN_PAY'
		   , @v_unit_cd NVARCHAR(100) = 'REP'
		   , @v_std_kind	NVARCHAR(2000) = 'REP_AVG_DC_ITEM_CD,REP_AVG_EXC_RSN_CD,REP_AVG_ITEM_CD,REP_AVG_MGR_ITEM_CD,REP_DEDUCT,REP_EXE_MUL,REP_INCOME_GONGJE,REP_INCOME_TAX_RATE'
...
-- DATABASE 확인
------------------------------
IF @@SERVERNAME = 'DWEHRDEV'
BEGIN
	PRINT 'DB를 확인하세요!' + @@SERVERNAME
	RETURN;
END
------------------------------

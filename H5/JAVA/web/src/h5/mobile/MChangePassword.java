...
public class MChangePassword extends HttpServlet { 
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try{ 
			result = firstWork( NEW_PASSWORD, USER_ID, COMPANY_CD, verification_cd,gubun);
	...
	public String firstWork(String newPwd, String userId, String companyCd , String verificationCd , String gubun) throws Exception {

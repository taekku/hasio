...
-- WHERE CNV_PAY_WORK_ID=1505
 WHERE PROGRAM_NM LIKE 'P_CNV_PAY_PAYROLL_FnB_PAY%'
   ...
   AND FORMAT(STA_TIME, 'yyyyMMdd')  = '20210602'
   --AND CNV_PAY_WORK_ID <= 1684
   --AND CNT_FAIL > 0
   --AND CNV_PAY_WORK_ID IN (1507)
ORDER BY PARAMS, CNV_PAY_WORK_ID
...
--DELETE A
 ...
 WHERE B.PROGRAM_NM LIKE 'P_CNV_PAY_PAYROLL_FnB_PAY%'
   --AND PARAMS LIKE '2,@company_cd=T%'
